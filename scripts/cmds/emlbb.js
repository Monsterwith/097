...
module.exports = {
  config: {
    ...
    cooldowns: 30,
    role: 0,
    shortDescription: "Get random mlbb edit video",
    longDescription: "Get random mlbb edit video",
    category: "fun",
    guide: "{p}mlbbedit",
  },
  ...
  onStart: async function ({ api, event, args, message }) {
    ...
    try {
      const response = await axios.get("https://mlbb-vxhy.onrender.com/kshitiz");
